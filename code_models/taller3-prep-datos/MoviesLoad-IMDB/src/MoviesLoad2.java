...
public class MoviesLoad2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while((linea=abr.readLine())!=null){
                ...
                System.out.println("Elementos en el arbol: " + movies.size());
            }
            crearCSV(movies);
    ...
    public static void crearCSV(HashMap<String, String> map){
        ...
        try (Writer writer = new FileWriter("directores1.csv")) {
